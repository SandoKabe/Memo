{
  mode: 'production',
  context: 'C:\\work\\Project\\VueJS\\Fundamentals\\build-a-bot',
  devtool: 'source-map',
  node: {
    setImmediate: false,
    process: 'mock',
  ...
  output: {
    path: 'C:\\work\\Project\\VueJS\\Fundamentals\\build-a-bot\\dist',
  ...
  resolve: {
    alias: {
      '@': 'C:\\work\\Project\\VueJS\\Fundamentals\\build-a-bot\\src',
    ...
    modules: [
      'node_modules',
      'C:\\work\\Project\\VueJS\\Fundamentals\\build-a-bot\\node_modules',
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            ...
            options: {
              cacheDirectory: 'C:\\work\\Project\\VueJS\\Fundamentals\\build-a-bot\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '28ae0c5a'
            }
          },
        ...
        use: [
          /* config.module.rule('eslint').use('eslint-loader') */
          {
            ...
            options: {
              ...
              cache: true,
              cacheIdentifier: '057c81d3',
              emitWarning: false,
              emitError: false,
              eslintPath: 'C:\\work\\Project\\VueJS\\Fundamentals\\build-a-bot\\node_modules\\eslint',
              formatter: undefined
            }
          }
        ]
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'C:\\work\\Project\\VueJS\\Fundamentals\\build-a-bot\\public\\index.html'
      }
    ),
    ...
    new CopyPlugin(
      [
        {
          from: 'C:\\work\\Project\\VueJS\\Fundamentals\\build-a-bot\\public',
          to: 'C:\\work\\Project\\VueJS\\Fundamentals\\build-a-bot\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store',
            {
